...
namespace ValheimRebalanced
{
    ...
    {
        private const string PrefabName = "StaffFireball";
        ...
        {
            ItemDrop.ItemData.SharedData shared = Items.Shared(ObjectDB.instance, PrefabName, "the Staff of Embers");
            if (shared == null)
            {
                return;
            }
            ...
            float multiplier = ConfigSync.Current.StaffOfEmbersBlunt;
