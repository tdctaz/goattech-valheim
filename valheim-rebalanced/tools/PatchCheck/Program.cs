...
// otherwise have surfaced as a silent no-op or a startup exception at startup.
//
// Run this after every game update. It is the cheap half of re-verifying the mod.

if (args.Length < 2)
{
    Console.Error.WriteLine("usage: PatchCheck <ValheimRebalanced.dll> <valheim Managed dir>");
    return 2;
}
